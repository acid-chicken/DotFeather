...
namespace DotFeather.Demo {
  public static class DemoOS {
    ...
    /// </summary>
    public static Folder CurrentDirectory {
      get;
      set;
    }
    = Root;
    ...
    public static void Init() {
      ...
      var scenes =
          typeof (DemoOS)
              .Assembly.GetTypes()
              .Select(t => (t, a
                            : t.GetCustomAttribute<DemoSceneAttribute>()))
              .Where(t => t.a != null);
      ...
      foreach(var (type, attr) in scenes) {
        ...
        type.GetCustomAttributes<DescriptionAttribute>().ToList().ForEach(
            desc => file.Description[desc.Language] = desc.Text);
