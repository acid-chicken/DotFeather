...
namespace DotFeather.Demo {
  ...
  [Description("en",
               "Run a heavy task to generate texture with await expression")]
  [Description("ja",
               "await 式を用いてテクスチャを生成する重たいタスクを実行する例")]
  public class AsyncAwaitPatternExampleScene : Scene {
    public override async void OnStart(Router router, GameBase game,
