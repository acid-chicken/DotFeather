...
namespace DotFeather.Demo {
  ...
  public class Sample1ExampleScene
      : Scene{public override void OnStart(Router router, GameBase game,
...
public class Sample5ExampleScene : Scene {
  ...
  public override void OnUpdate(Router router, GameBase game, DFEventArgs e) {
    text.Text = $@"Container: {(VectorInt)container.Location} Relative
        : {(VectorInt) text.Location} Absolute : {
      (VectorInt) text.AbsoluteLocation
    }
    ";
  ...
  private readonly TextDrawable text =
