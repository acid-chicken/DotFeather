...
namespace DotFeather.Demo {
  ...
  public class ScreenshotExampleScene : Scene {
    ...
    public override void OnDestroy(Router router) { tex.Dispose(); }
    ...
    IEnumerator DrawAll(GameBase game) {
      ...
      for (var i = 0; i < 120; i++) {
        ...
        case 0:
          ...
          break;
        case 1:
          g.Rect(Rnd(), Rnd(), Random.NextColor(), Random.Next(4),
                 Random.NextColor());
          break;
        case 2:
          g.Ellipse(Rnd(), Rnd(), Random.NextColor(), Random.Next(4),
                    Random.NextColor());
          break;
        case 3:
          ...
          break;
        case 4:
          g.Triangle(Rnd(), Rnd(), Rnd(), Random.NextColor(), Random.Next(4),
                     Random.NextColor());
          break;
        }
        yield return null;
