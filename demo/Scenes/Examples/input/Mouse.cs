  ...
  public class MouseExampleScene : Scene {
    ...
    public string Left() {
      return DFMouse.IsLeftDown ? "Pressed"
          : DFMouse.IsLeftUp ? "Released" : DFMouse.IsLeft ? "Pressing" : "";
    }

    public string Middle() {
      return DFMouse.IsMiddleDown ? "Pressed"
          : DFMouse.IsMiddleUp ? "Released" : DFMouse.IsMiddle ? "Pressing" : "";
    }

    public string Right() {
      return DFMouse.IsRightDown ? "Pressed"
          : DFMouse.IsRightUp ? "Released" : DFMouse.IsRight ? "Pressing" : "";
    }
  }
}
