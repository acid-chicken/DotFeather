...
public class DelegateAudioSource : IAudioSource {
  ...
  /// <summary>
  /// Initialize a new instance of <see cref="DelegateAudioSource"/> class with
  /// specified file path.
  /// </summary>
  public DelegateAudioSource(AudioGeneratorDelegate d) { audioGenerator = d; }
...
public delegate(short left, short right)
    ? AudioGeneratorDelegate(int sampleCount, int ? loopStart);
}
