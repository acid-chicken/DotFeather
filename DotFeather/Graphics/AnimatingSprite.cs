...
public class AnimatingSprite : Sprite, IUpdatable {
  ...
  /// <summary>
  /// Get and set loop times. If -1, animation loops infinity, and if 0,
  ...
  /// <summary>
  /// Initialize a new instance of <see cref="AnimatingSprite"/> class by
  /// parameters.
  /// </summary>
  /// <param name="textures">An array of texture.</param>
  /// <param name="loopTimes">Loop times. If -1, animation loops infinity, and
  /// if 0, animation won't loop.</param> <param name="duration">Animation time
  /// in frame.</param>
