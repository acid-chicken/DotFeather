...
public abstract class Scene {
  ...
  /// </summary>
  /// <param name="seed">Seed value. If not specified, using a default
  /// constructor of <see cref="Random"/> to initialize. </param>
    ...
    /// </summary>
    public virtual void OnStart(Router router, GameBase game,
