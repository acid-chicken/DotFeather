...
public class Router {
  ...
  /// <summary>
  /// Initialize a new instance of <see cref="Router"/> class with the specified
  /// parent game class.
  /// </summary>
  /// <param name="gameBase"></param>
  public Router(GameBase gameBase) { Game = gameBase; }
  ...
  /// </summary>
    ...
    private readonly Dictionary<string, Func<Scene>>dic =
        new Dictionary<string, Func<Scene>>();
}
}
