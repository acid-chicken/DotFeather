...
public struct VectorInt : IEquatable<VectorInt> {
  ...
  /// <param name="x"></param>
  /// <param name="y"></param>
  public VectorInt(int x, int y) { (X, Y) = (x, y); }

  public static VectorInt operator +(VectorInt v1, VectorInt v2) =>
      new VectorInt(v1.X + v2.X, v1.Y + v2.Y);

  public static VectorInt operator -(VectorInt v1, VectorInt v2) =>
      new VectorInt(v1.X - v2.X, v1.Y - v2.Y);

  public static VectorInt
  operator *(VectorInt v1, int v2) => new VectorInt(v1.X * v2, v1.Y *v2);

  public static VectorInt operator *(VectorInt v1,
                                     VectorInt v2) => new VectorInt(v1.X * v2.X,
                                                                    v1.Y *v2.Y);
  ...
  public static VectorInt operator -(VectorInt v1) => new VectorInt(-v1.X,
                                                                    -v1.Y);

  public static implicit operator Vector(VectorInt v1) => new Vector(v1.X,
                                                                     v1.Y);

  public static bool operator ==(VectorInt v1, VectorInt v2) => v1.X == v2.X
                                                                && v1.Y == v2.Y;
  ...
  public static float Angle(VectorInt from,
                            VectorInt to) => MathF.Atan2(to.Y - from.Y,
                                                         to.X - from.X);
  ...
  public static float Distance(VectorInt from, VectorInt to) =>
      MathF.Sqrt(MathF.Abs((to.X - from.X) * (to.X - from.X) +
  ...
  /// Compare this object.
  /// </summary>
  public bool Equals(VectorInt other) { return X == other.X && Y == other.Y; }
