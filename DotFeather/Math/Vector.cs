...
public struct Vector : IEquatable<Vector> {
  ...
  operator +(Vector v1, Vector v2) => new Vector(v1.X + v2.X, v1.Y + v2.Y);

  public static Vector
  operator -(Vector v1, Vector v2) => new Vector(v1.X - v2.X, v1.Y - v2.Y);

  public static Vector operator *(Vector v1, float v2) => new Vector(v1.X * v2,
                                                                     v1.Y *v2);
  ...
  public static bool operator ==(Vector v1, Vector v2) => v1.X == v2.X
                                                          && v1.Y == v2.Y;
  ...
  operator VectorInt(Vector v1) => new VectorInt((int) v1.X, (int) v1.Y);
  ...
  public static float
  Angle(Vector from, Vector to) => MathF.Atan2(to.Y - from.Y, to.X - from.X);

  /// <summary>
  /// Get the distance between 2 vectors.
  /// </summary>
  public static float Distance(Vector from, Vector to) => MathF.Sqrt(MathF.Abs(
